...
//            InterfaceBarang iBarang = new daoBarang();
            ...
            trx.setNama_pembeli("udin");
            trx.setAlamat_pembeli("MLG");
            trx.setTelepon("08646484664");
            trx.setNama_barang("Gazelle");
            trx.setNama_brand("adidas");
            trx.setQty(2);
            trx.setHarga_satuan(500000);
            trx.setHarga_satuan(1000000);
//            trx.setTanggal(getTgl());
